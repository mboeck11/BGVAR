...
BVAR_linear <- function(Yraw, Wraw, Exraw, plag, draws, burnin, thin, cons, trend, sv, prior, hyperparam, setting_store) {
    .Call(`_BGVAR_BVAR_linear`, Yraw, Wraw, Exraw, plag, draws, burnin, thin, cons, trend, sv, prior, hyperparam, setting_store)
}
